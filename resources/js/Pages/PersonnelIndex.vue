<template>
    <app-layout>
        ...
        <inertia-link v-if="is_admin" :href="route('personnels.create', {year})">
            <button
                class="p-0 w-16 h-16 bg-pink-600 rounded-full hover:bg-pink-700 active:shadow-lg cursor-pointer shadow-sm transition ease-in duration-200 focus:outline-hidden fixed bottom-6 right-6">
