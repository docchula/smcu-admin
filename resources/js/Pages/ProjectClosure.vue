        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                ...
                <template #form>
                    ...
                    <div class="col-span-3 space-y-2">
                        ...
                        <p v-else class="text-xs text-gray-500 col-span-6">
                            ผู้เข้าร่วมอาจเป็นนิสิตแพทย์หรือบุคคลอื่นก็ได้ ควรอธิบายที่มาของจำนวนผู้เข้าร่วมหรือแนบหลักฐานในเอกสารรายงานผลด้วย
                        </p>
                    </div>
                </template>
            </jet-form-section>
            ...
            <jet-form-section>
                ...
                <template #description>กรุณาดาวน์โหลดไฟล์ แก้ไข/เติมรายละเอียดให้ครบถ้วน (หรือใช้แบบฟอร์มที่สพจ. แจกจ่าย)
                    ...
                    เรียนรองคณบดีด้านกิจการนิสิตตามขั้นตอนต่อไป (ออกเลขเอกสารในเมนู สารบรรณ)
                </template>
                <template #form>
                    <div class="col-span-6">
            ...
            <jet-form-section @submitted="submit">
                ...
                <template #form>
                    ...
                    <p class="col-span-6 text-gray-500">
                        ...
                        และสนับสนุน Outcome ของหลักสูตรแพทยศาสตรบัณฑิต โดยผ่านการพิจารณาของผู้ช่วย/รองคณบดีด้านกิจการนิสิต
                    </p>
                </template>
                <template #actions>
