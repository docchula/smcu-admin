                ...
                <template v-if="signers && signers.length > 0">
                    ...
                    <table>
                        ...
                        <tr v-if="item.tag === 'approval'">
                            <td class="px-1">-</td>
                            <td class="px-2" colspan="3">แล้วส่งต่อไฟล์ที่ผู้เกี่ยวข้องลงลายมือชื่อผ่านระบบแล้ว ไปยังงานกิจการนิสิต
                                (studentmd@chula.md) โดยขอให้เจ้าหน้าที่งานกิจการนิสิตพิมพ์และนำเรียนรองคณบดีลงลายมือชื่อบนกระดาษ
                            </td>
                        </tr>
                        <tr v-else-if="item.recipient === 'รองคณบดีด้านกิจการนิสิต'">
                            <td class="px-1">-</td>
                            <td class="px-2" colspan="3">รองคณบดีด้านกิจการนิสิต (เป็นผู้รับไม่ต้องมีช่องให้ลงชื่อในเอกสาร)</td>
                        </tr>
                        <tr v-else>
                            <td class="px-1">-</td>
                            <td class="px-2">ผศ.นพ.อติคุณ ธนกิจ</td>
                            <td class="px-2" colspan="2">รองคณบดีด้านกิจการนิสิต</td>
                        </tr>
                    </table>
                </template>
