<template>
    ...
    <!--div class="items-top justify-center pb-12 bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="px-6 py-4 sm:block text-right">
            ...
            <template v-else>
                <a :href="route('login.google')" class="text-sm text-gray-700 underline">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                href="https://vapor.laravel.com" class="underline">Vapor</a>, <a href="https://nova.laravel.com" class="underline">Nova</a>, and <a href="https://envoyer.io"
                                                                                                                                                                    class="underline">Envoyer</a> help
                                you take your projects to the next level. Pair them with powerful open source libraries like <a href="https://laravel.com/docs/billing" class="underline">Cashier</a>,
            ...
            <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <a href="https://docchula.com" class="ml-1 hover:underline">
